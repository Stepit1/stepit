...
class Terminal(Aeroport):
    def __init__(self, name, iata_code, country, city, numar_terminal, numar_porti_imbarcare):
    ...
    def inscriere_pasager(self, name):
        self.pasageri_in_terminal.append(name)
        print(f"Pasagerul {name} a fost inscris in terminalul {self.numar_terminal}.")
    
    def debarcare_pasager(self, name):
        if name in self.pasageri_in_terminal:
            self.pasageri_in_terminal.remove(name)
            print(f"Pasagerul {name} a fost debarcat din terminalul {self.numar_terminal}.")
        else:
            print(f"Pasagerul {name} nu exista in terminalul {self.numar_terminal}.")
