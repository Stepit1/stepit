class Aeroport:
    ...
    def display(self):
        print(f"Cel mai mare aeroport din sudul europei este {self.name}, acesta se afla in {self.country}. "
...
class Terminal(Aeroport):
    def __init__(self, nume, iata_code, country, numar_terminal, numar_porti_imbarcare):
        super().__init__(nume, iata_code, country)
